---
title: "NFTエンジニアを目指そう！独自コントラクトのNFTを作るページの紹介"
...
おまけでノーコードで独自コントラクトを作るサービスも載せておきます。ノーコードなのでエンジニア以外でもERC721やERC1155のスマートコントラクトをメインネットデプロイできます。
...
## NFTの分類
NFTの種類は無数に存在しますが、ここでは2021~2022年現在開発が活発になっているNFTについて紹介します。
...
理由は、オンチェーンにこれらの画像データを乗せるとストレージコストが高いためです。
...
### ノーコード
ERC20, ERC721, ERC1155など汎用的なスマートコントラクトをノーコードでデプロイできます。
...
有益な記事を作成してくださったエンジニア著者の皆さまに敬意と感謝の気持ちを込めて
